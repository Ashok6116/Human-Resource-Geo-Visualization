...
#Data Load
MANIPUR=pd.read_csv("D:/labour_project/MANIPUR.csv",encoding="cp1252")
#Title
...
oly_total=MANIPUR[MANIPUR['NIC Name']=='Total']
...
coords = pd.read_csv("D:/labour_project/manipurs.csv")
lat=list(coords['lat'])
log=list(coords['lon'])
...
fig = px.scatter_map(new_oly, lat="latitude", 
                  ...
                  color_continuous_scale=px.colors.cyclical.IceFire,
                    size_max=15, zoom=5, title="MANIPUR District-wise Total Workers Distribution")
