...
#Data Load
JHARKHAND=pd.read_csv("D:/labour_project/JHARKHAND.csv",encoding="cp1252")
#Title
...
oly_total=JHARKHAND[JHARKHAND['NIC Name']=='Total']
...
sunburst_df = JHARKHAND[
    (JHARKHAND["Division"] != 0) &
    (JHARKHAND["Group"] != 0) &
    (JHARKHAND["Class"] != 0)]
...
'''for i in new_oly['India/States']:
    st.write(i)'''
st.write(new_oly)
coords = pd.read_csv("D:/labour_project/jharkhands.csv")
lat=list(coords['lat'])
log=list(coords['lon'])
