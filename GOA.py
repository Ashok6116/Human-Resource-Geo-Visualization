...
#Data Load
GOA=pd.read_csv("D:/labour_project/GOA.csv",encoding="cp1252")
#Title
...
oly_total=GOA[GOA['NIC Name']=='Total']
...
'''for i in new_oly['India/States']:
    st.write(i)'''
st.write(new_oly)
coords = pd.read_csv("D:/labour_project/goas.csv")
lat=list(coords['lat'])
log=list(coords['lon'])
