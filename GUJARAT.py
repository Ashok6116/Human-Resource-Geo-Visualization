...
#Data Load
GUJARAT=pd.read_csv("D:/labour_project/GUJARAT.csv",encoding="cp1252")
#Title
...
oly_total=GUJARAT[GUJARAT['NIC Name']=='Total']
...
'''for i in new_oly['India/States']:
    st.write(i)'''
st.write(new_oly)
coords = pd.read_csv("D:/labour_project/gujarat_log_lat.csv")
lat=list(coords['lat'])
log=list(coords['lon'])
